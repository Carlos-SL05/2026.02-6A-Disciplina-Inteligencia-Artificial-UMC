...
# Estrutura
- 2026.02-6A-Disciplina-Inteligencia-Artificial-UMC - M1-Lista de exercícios python
  - Pasta: Documentos da atividade
    - Arquivo: Lista.pdf -- Lista de Exercícios Python
  - Arquivo: Exercícios_Python_Carlos_6°A_Manhã.ipynb -- Resolução dos exercícios
